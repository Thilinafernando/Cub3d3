...
/*   Updated: 2025/07/09 03:42:57 by ilmahjou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int ac, char **av)
{
    ...
    mlx_hook(game.win, 6, 1L<<6, mouse_move, &game);             // MotionNotify/bonus
    mlx_hook(game.win, 4, 1L<<2, mouse_press, &game);            // ButtonPress/bonus
    mlx_hook(game.win, 5, 1L<<3, mouse_release, &game);          // ButtonRelease/bonus
